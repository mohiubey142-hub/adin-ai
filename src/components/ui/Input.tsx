  ...
  ({ label, error, icon, className = "", type = "text", ...props }, ref) => {
    ...
    return (
      <div className="space-y-1.5">
        {label && (
          <label className="block text-sm font-medium text-[#d4d4d8] tracking-wide">
            {label}
          </label>
        )}
        <div className="relative">
          ...
          <input
            ...
            className={`
              w-full bg-[rgba(20,20,27,0.8)] 
              border-2 border-[rgba(124,58,237,0.2)] 
              ...
              focus:border-[#7c3aed] 
              focus:outline-none 
              focus:ring-4 focus:ring-[rgba(124,58,237,0.1)]
              hover:border-[rgba(124,58,237,0.4)]
              hover:bg-[rgba(24,24,31,0.85)]
