  ...
  const templates: Template[] = [
    {
      ...
      status: 'active',
      previewImage: "/src/components/Templates/images/modern.webp",
      rating: 4.9,
      reviews: 1247,
      atsScore: 95,
    ...
    },
    {
      ...
      status: 'active',
      previewImage: "/src/components/Templates/images/minimal.webp",
      rating: 4.8,
      reviews: 893,
      atsScore: 90,
    ...
    },
    {
      ...
      status: 'coming-soon',
      previewImage: "/src/components/Templates/images/professional.webp",
      rating: 0,
      reviews: 0,
      atsScore: 0,
      features: []
    },
    {
      ...
      status: 'coming-soon',
      previewImage: "/src/components/Templates/images/executive.webp",
      rating: 0,
      reviews: 0,
      atsScore: 0,
      features: []
    },
    {
      ...
      status: 'coming-soon',
      previewImage: "/src/components/Templates/images/creative.webp",
      rating: 0,
      reviews: 0,
      atsScore: 0,
      features: []
    },
    {
      ...
      status: 'coming-soon',
      previewImage: "/src/components/Templates/images/academic.webp",
      rating: 0,
      reviews: 0,
      atsScore: 0,
      features: []
