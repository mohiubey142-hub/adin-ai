// src/components/Templates/CoverTemplatesPage.tsx
...
interface CoverTemplatesPageProps {
  onBackToHome?: () => void;
  onTemplateSelect?: (templateId: string) => void;
}

const CoverTemplatesPage = ({ onBackToHome, onTemplateSelect }: CoverTemplatesPageProps) => {
  ...
  const templates: Template[] = [
    {
      ...
      description: "A modern cover letter with clean typography and subtle design elements.",
      bestFor: ["Creative", "Tech", "Marketing"],
      badges: ["ATS Optimized", "Popular"],
      gradient: "from-purple-600 to-pink-500",
      status: 'active',
      previewImage: "/Templates/images/cover-modern.webp",
      rating: 4.9,
      reviews: 1247,
      atsScore: 95,
    ...
    },
    {
      ...
      description: "A timeless formal cover letter design. Perfect for corporate positions.",
      bestFor: ["Corporate", "Legal", "Executive"],
      badges: ["ATS Optimized", "Professional"],
      gradient: "from-blue-600 to-indigo-500",
      status: 'active',
      previewImage: "/Templates/images/cover-classic.webp",
      rating: 4.8,
      reviews: 893,
      atsScore: 90,
      features: ["Single Page", "Classic Design", "Easy to Customize"]
    },
    {
      id: "minimal",
      name: "Minimal",
      subtitle: "Clean & Simple",
      description: "A minimalist cover letter that lets your content shine.",
      bestFor: ["Design", "Freelance", "Creative"],
      badges: [],
      gradient: "from-gray-600 to-zinc-500",
      status: 'coming-soon',
      previewImage: "/Templates/images/cover-minimal.webp",
      rating: 0,
      reviews: 0,
      atsScore: 0,
      features: []
    },
    {
      ...
      status: 'coming-soon',
      previewImage: "/Templates/images/cover-professional.webp",
      rating: 0,
      reviews: 0,
      atsScore: 0,
      features: []
    },
    {
      ...
      status: 'coming-soon',
      previewImage: "/Templates/images/cover-executive.webp",
      rating: 0,
      reviews: 0,
      atsScore: 0,
      features: []
    },
    {
      ...
      status: 'coming-soon',
      previewImage: "/Templates/images/cover-creative.webp",
      rating: 0,
      reviews: 0,
      atsScore: 0,
      features: []
  ...
  const filterOptions = ["All Templates", "Modern", "Classic", "Minimal", "Professional", "Executive", "Creative"];
  ...
  // ✅ Get SEO config for cover templates page
  const seoConfig = getSEOConfig('cover-templates');

  return (
    <>
      {/* ✅ SEO: Cover Templates Page */}
      <SEOHead
      ...
      {/* ✅ JSON-LD: Cover Templates Schema */}
      <script type="application/ld+json">
        {generateJSONLDScript(generatePageSchemas('cover-templates'))}
      </script>
      ...
      <div className="min-h-screen bg-black overflow-y-auto">
        ...
        <div className="h-[48px] flex justify-between items-center px-4 md:px-6 border-b border-zinc-900 bg-black/50 backdrop-blur-sm sticky top-0 z-10">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5">
              <div className="w-5 h-5 md:w-6 md:h-6 rounded-lg bg-gradient-to-br from-purple-600 to-pink-500 flex items-center justify-center shadow-lg">
                <FileText size={10} className="md:text-sm text-white" />
              </div>
              <span className="text-[10px] md:text-xs font-medium text-white">Cover Letter Templates</span>
            </div>
          </div>
        </div>

        {/* Hero Section - Reduced padding for tighter spacing */}
        <div className="relative overflow-hidden px-4 md:px-6 pt-1 pb-1 md:pt-2 md:pb-2 border-b border-zinc-900">
          ...
          <div className="relative max-w-4xl mx-auto text-center">
            <h1 className="text-[10px] md:text-[20px] font-bold bg-gradient-to-r from-purple-400 via-pink-400 to-purple-400 bg-clip-text text-transparent mb-0.5 md:mb-1">
              Choose Your Cover Letter Template
            </h1>
            <p className="text-gray-300 text-[7px] md:text-[11px] max-w-2xl mx-auto">
              Professional ATS-Optimized Cover Letter Templates
            </p>
          </div>
        </div>
        ...
        {/* Templates Grid - Natural page scroll with reduced top padding */}
        <div className="px-4 md:px-6 pt-3 md:pt-4 pb-6 md:pb-8">
          <div className="max-w-[900px] mx-auto">
              ...
              {filteredTemplates.map((template) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Template Preview - Vertical Layout */}
                    <div className="relative p-2 md:p-3 h-full">
                      <div className={`relative rounded-lg md:rounded-xl overflow-hidden bg-zinc-950 border ${isActive ? 'border-zinc-800 group-hover:border-zinc-700' : 'border-zinc-800/50 group-hover:border-zinc-700'} transition-colors duration-300 h-full flex flex-col`}>
                        ...
                        <div className="relative flex justify-center items-center p-2 md:p-3 w-full" style={{ minHeight: "528px", height: "528px" }}>
                          ...
                          {/* Coming Soon Badge - Top Right with Lock Icon */}
                          {isComingSoon && (
                        ...
                        {/* Badges - POPULAR on image - Only for active */}
                        ...
                        {/* PREVIEW Label on image - For all templates */}
                        ...
                        {/* Badges on image - Only for active templates */}
                        {isActive && (
                            ...
                            {template.badges.map((badge) => {
                              ...
                              return (
                                ...
                                >
                                  ...
                                  {badge === "Professional" && <Users size={7} className="md:w-[8px] md:h-[8px] text-blue-400" />}
                                  {badge}
                                </span>
                              );
                            })}
                        ...
                        <div className="h-[132px] p-3 md:p-4 pt-2 md:pt-3 flex flex-col justify-center overflow-y-auto custom-scrollbar">
                          ...
                          {/* Actions - Buttons - Perfectly aligned row */}
                          <div className="flex gap-2 mt-1.5 md:mt-2">
                            {/* Preview Button - Works for ALL templates */}
                            <button
                            ...
                            {/* Use Template Button or Coming Soon */}
                            {isActive ? (
                              <button
                                onClick={() => handleUseTemplate(template.id)}
                                className="flex-1 px-2 md:px-3 py-1.5 md:py-2 rounded-lg md:rounded-xl bg-gradient-to-r from-purple-600 to-pink-500 text-white text-[9px] md:text-[10px] font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/25 flex items-center justify-center gap-1 md:gap-1.5 min-h-[32px] md:min-h-[36px]"
            ...
            <div className="mt-6 md:mt-8 pt-6 md:pt-8 border-t border-zinc-900 max-w-[900px] mx-auto">
              <h2 className="text-sm md:text-base lg:text-lg font-bold text-center mb-4 md:mb-6 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
                Why Our Cover Letter Templates?
              </h2>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
                {[
                  ...
                  },
                  {
                    ...
                    title: "Export Ready",
                    desc: "Export your cover letter in PDF format, ready to share with employers"
                  }
                ].map((item, idx) => (
                  <div
                    key={idx}
                  ...
                  >
                    <div className="w-8 h-8 md:w-10 md:h-10 mx-auto rounded-lg md:rounded-xl bg-gradient-to-br from-purple-600/20 to-pink-500/20 flex items-center justify-center mb-1.5 md:mb-2 group-hover:scale-110 transition-transform text-purple-400">
                      {item.icon}
                    </div>
        ...
        {previewTemplate && (
          ...
          >
            ...
            >
              ...
              {/* ✅ Modal Footer - Coming Soon button disabled */}
              <div className="p-3 md:p-4 border-t border-zinc-800 flex justify-between items-center shrink-0">
                ...
                {previewTemplate.status === 'active' ? (
                  <button
                    ...
                    className="px-4 md:px-6 py-1.5 md:py-2 rounded-lg md:rounded-xl bg-gradient-to-r from-purple-600 to-pink-500 text-white text-[10px] md:text-xs font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/25 flex items-center gap-1.5 md:gap-2"
        ...
        <style>{`
          /* ✅ FIX: Hide scrollbar for filter buttons */
