...
const AIEnhancerPanel: React.FC<AIEnhancerPanelProps> = ({
    ...
    return (
        ...
        <div className="space-y-3 sm:space-y-4">
            {/* AI Provider Selector - Mobile optimized */}
            <div className="p-3 sm:p-4 lg:p-5 rounded-xl bg-gray-900/50 border border-purple-500/20 backdrop-blur-sm">
                ...
                <div className="flex gap-2 sm:gap-3 flex-wrap">
                    {/* Model 1: Adin AI Swift (was OpenRouter) */}
                    <button
                        onClick={() => onProviderChange('openrouter')}
                        className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl text-[10px] sm:text-xs font-semibold transition-all duration-300 flex flex-col items-start gap-0.5 touch-manipulation min-h-[44px] sm:min-h-[48px] flex-1 sm:flex-none ${
                    ...
                    {/* Model 2: Adin AI Elite (was Groq Llama) */}
                    <button
            ...
            <div className="p-3 sm:p-4 lg:p-5 rounded-xl bg-gray-900/50 border border-purple-500/20 backdrop-blur-sm">
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-3">
                    <button
                        ...
                        disabled={isLoading === 'summary' || !hasJobTitle}
                    ...
                    <button
                        ...
                        disabled={isLoading === 'exp-0' || !hasExperiences}
            ...
            {/* AI Enhancer - 8 Options - Mobile optimized */}
            <div className="p-3 sm:p-4 lg:p-5 rounded-xl bg-gray-900/50 border border-purple-500/20 shadow-xl transition-all duration-300 hover:border-purple-500/40 backdrop-blur-sm">
                ...
                <div className="flex items-center justify-between gap-2 sm:gap-3 mb-2 sm:mb-3">
                    ...
                    <button
                        ...
                        disabled={!isEnhancerUsed || !hasOriginalSummary}
                        className={`px-2.5 sm:px-3.5 py-1 sm:py-1.5 rounded-xl text-[9px] sm:text-[11px] font-semibold transition-all duration-300 flex items-center gap-1 sm:gap-1.5 touch-manipulation min-h-[28px] sm:min-h-[32px] backdrop-blur-sm ${
                            isEnhancerUsed && hasOriginalSummary
                    ...
                    >
                        <RefreshCw size={10} className={isEnhancerUsed && hasOriginalSummary ? 'animate-pulse' : ''} />
                ...
                <div className="grid grid-cols-2 gap-1.5 sm:gap-2">
                    {aiEnhancerOptions.map((option) => (
                        <button
                            ...
                            disabled={isEnhancerLoading === option.id}
                            className={`
